...
Read these files **after** loading the design system (`SKILL.md` / `DESIGN.md` + token modules). The design system tells you _what_ token to use; these files explain _why_ that decision is correct and _how_ to avoid common principle violations.
